    ...
    function initStationAdmin() {
        ...
        function toggleDecodingFields() {
            ...
            if (analogChecked) {
                ...
                // If Digital selected, enable decoding fields
                decodingFields.forEach(function(fieldId) {
