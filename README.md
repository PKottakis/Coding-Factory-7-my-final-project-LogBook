...
Στόχος ήταν η δημιουργία ενός έργου με πραγματική χρησιμότητα, ώστε να αποτελέσει ένα εργαλείο και όχι απλώς μια κώδικα-εργασία 
που θα ξεχαστεί.  

Η εφαρμογή αφορά την καταγραφή **ραδιοφωνικών σταθμών (DX Radio)** και επαφών **ραδιοερασιτεχνών (LogBook)**.  
Η κοινότητα των ραδιοερασιτεχνών αριθμεί περισσότερα από **3 εκατομμύρια μέλη παγκοσμίως**. Για τον λόγο αυτό, σε μελλοντικές 
εκδόσεις προβλέπεται υποστήριξη επιπλέον γλωσσών και νέων λειτουργιών.  

## 🙏 Ευχαριστίες
Θα ήθελα να εκφράσω τις ειλικρινείς μου ευχαριστίες στον **Υπεύθυνο Καθηγητή Προγράμματος, κ. Α. Ανδρούτσο**, καθώς και στους 
καθηγητές:
...
για την πολύτιμη καθοδήγηση, τη συνεχή υποστήριξη και τις γνώσεις που μου προσέφεραν καθ’ όλη τη διάρκεια του προγράμματος.
Η συμβολή τους υπήρξε καθοριστική για την ολοκλήρωση του έργου αυτού.
...
![Queries Screen](screenshots/Queries.JPG)
...
![Add Station](screenshots/AddStation.JPG)
